  ...
  */
  ...
  var SKILL_DATA = {
    ...
    claude: {
      ...
      rating: 4,
      points: [
        'Figma MCP 서버를 연동해 디자인 프레임을 직접 읽어와 페이지로 구현합니다.',
    ...
    gnuboard: {
      ...
      rating: 3.5,
      points: [
        '그누보드 스킨 구조를 이해하고 디자인에 맞춰 직접 수정합니다.',
        '기본 게시판 스킨을 사이트 디자인에 맞게 커스터마이징합니다.',
        '메인페이지와 서브페이지를 그누보드 환경에 맞춰 퍼블리싱합니다.',
        'PHP include 구조를 활용해 헤더·푸터 등 공통 영역을 관리합니다.',
        '관리자 페이지에서 게시판을 생성하고 권한·옵션을 설정합니다.'
      ]
    }
  };
  ...
  var PUB_DATA = {
    ...
    nomia: {
      ...
      badge: '포트폴리오',
      role: '디자인 100%, 퍼블리싱 100%',
      scope: '전체페이지(프론트페이지, 서브페이지) 및 반응형 웹',
      tools: 'HTML5, CSS3, Javascript, Vscode, Figma, PHP Include',
      period: '07.03 ~ 07.18 (총 16일중 13일 제작 3일 부재)',
    ...
    burgerking: {
      ...
      role: '디자인 100%, 퍼블리싱 100%',
      scope: '메인페이지 및 반응형 웹',
      tools: 'HTML5, CSS3, Javascript, Vscode, Figma',
      period: '25.06.18 ~ 25.06.29 (12일)',
    ...
    newbalance: {
      ...
      role: '퍼블리싱 100%',
      scope: '메인페이지',
      tools: 'HTML5, SCSS, JQuery, Vscode, Figma',
      period: '25.06.01 ~ 25.06.05 (6일)',
